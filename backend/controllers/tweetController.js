...
const likeTweet = async(req,res)=>{
    ...
    try {
        ...
        // check here to see if this user has already liked this post
...
const createComment2 = async(req,res)=>{
    ...
    // add the recently created comment which is actually a tweet in the replies array.
...
// isAReTweet field allows us to check if a tweet is retweet or not.
    ...
    // ! what is tweetedBy? tweetedBy is the user who is retweeting
